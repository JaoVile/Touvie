...
export const TARGETS = [
  ...
  },
  {
    ...
    queries: [
      ...
      "wood fire ambience",
      "bonfire crackle calm",
      "hearth fire soft",
    ],
    must: ["fire", "campfire", "fireplace", "crackl"],
    avoid: ["gun", "explosion", "engine", "city", "scary", "alarm"],
  },
  {
    key: "violinos",
    variants: 3,
    queries: [
      ...
      "warm strings loop",
      "legato strings calm",
      "soft sustained strings pad",
      "calm violin ambient drone",
      "peaceful cello ambient",
      "gentle string quartet slow",
      "ambient orchestral strings calm",
    ],
  ...
  },
  {
    ...
    queries: [
      ...
      "fingerstyle acoustic guitar calm",
      "soft acoustic guitar loop",
      "ambient classical guitar",
      "gentle acoustic guitar background",
      "ambient acoustic guitar soundscape",
      "calm instrumental guitar piece",
      "meditative guitar music",
      "relaxing nylon guitar",
      "peaceful fingerstyle guitar",
    ],
